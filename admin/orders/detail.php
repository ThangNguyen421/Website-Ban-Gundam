...
<body>
    <div class="container mt-5">
        <a href="list.php" class="btn btn-warning mb-3">Trở về Danh sách Đơn hàng</a>
            ...
            <div class="col-md-5">
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <p><strong>Email:</strong> <?php echo htmlspecialchars($order['EmailKhachHang']); ?></p>
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <p><strong>Người nhận:</strong> <?php echo htmlspecialchars($order['TenKhachHang']); ?></p>
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <?php foreach ($order['items'] as $item): ?>
                    <?php $subtotal = $item['SoLuong'] * $item['GiaBan'];
                    $totalAmount += $subtotal; ?>
                    <tr>
                        <td style="width: 100px;">
                            <?php if ($item['URLAnhChinh']): ?>
                                <img src="../../<?php echo htmlspecialchars($item['URLAnhChinh']); ?>" alt="Ảnh SP" style="width: 80px; height: 80px; object-fit: cover;">
                            <?php else: ?>
                                N/A
                            <?php endif; ?>
                        </td>
